...
#  source   = "./module_vpc1st/VPC_module"
  source = "github.com/dibyasachi001/simple_vpc_infra/VPC_module"
...
module "Pub_Sub_module" {
  ...
  source = "github.com/dibyasachi001/simple_vpc_infra/Pub_Sub_module"
...
module "Pvt_Sub_module" {
  ...
  source = "github.com/dibyasachi001/simple_vpc_infra/Pvt_Sub_module"
  vpc_id             = module.VPC_module.vpc_id
...
module "IGW_module" {
  ...
  source = "github.com/dibyasachi001/simple_vpc_infra/IGW_module"
  vpc_id     = module.VPC_module.vpc_id
...
module "Pub_rt_module" {
  ...
  source = "github.com/dibyasachi001/simple_vpc_infra/Pub_rt_module"
  vpc_id       = module.VPC_module.vpc_id
...
module "Pvt_rt_module" {
  ...
  source = "github.com/dibyasachi001/simple_vpc_infra/Pvt_rt_module"
  vpc_id       = module.VPC_module.vpc_id
...
module "SG_module" {
  ...
  source = "github.com/dibyasachi001/simple_vpc_infra/SG_module"
  vpc_id     = module.VPC_module.vpc_id
...
module "EC2_module" {
  ...
  source = "github.com/dibyasachi001/simple_vpc_infra/EC2_module"
  ami_id         = var.ami_id
